        ...
        private void btnSure_Click(object sender, EventArgs e)
        {
            ...
            if (_isInsert)
            {
                ...
                else
                {
                    ...
                    if (a > 0)
                    {
                        ...
                        userLogHelper.InsertUserLog(DateTime.Now.ToString(), "添加值班人员。", CommonClass.UserName, null, null);
                        this.Close();
                    }
                    else
                    {
            ...
            else
            {
                ...
                if (b > 0)
                {
                    ...
                    userLogHelper.InsertUserLog(DateTime.Now.ToString(), "更新值班人员信息。", CommonClass.UserName, null, null);
                    this.Close();
                }
                else
                {
