...
namespace CSPN.DAL
{
    ...
    public class WellCurrentStateDAL : IWellCurrentStateDAL
    {
        ...
        private const string SELECT_Notice_Info = "select Report_Time,b.Terminal_ID,Well_State_ID,Name,Place,Icon,RealName from ((CSPN_Well_Current_State_Info as a inner join CSPN_Well_Info as b on a.Terminal_ID=b.Terminal_ID) inner join CSPN_Dic_Well_State_Info as c on a.Well_State_ID=c.ID) inner join CSPN_Operator_Info as d on b.Operator_ID=d.ID where Well_State_ID=7 or Well_State_ID=8 order by Report_Time desc";
        ...
        private const string UPDATE_Well_State_ID2 = "update CSPN_Well_Current_State_Info set Electricity='终端电量正常',Smoke_Detector='烟感无报警',Smoke_Power='烟感电量正常',Well_State_ID=@Well_State_ID where Terminal_ID=@Terminal_ID";
